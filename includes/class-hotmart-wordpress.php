...
// Verifica se o arquivo existe e é gravável antes de tentar limpá-lo
if (file_exists($log_file_path) && is_writable($log_file_path)) {
file_put_contents($log_file_path, '');
echo "<div class='updated'><p>Log limpo.</p></div>";
} else {
echo "<div class='error'><p>Erro ao limpar o log. Verifique as permissões do arquivo.</p></div>";
}
}
